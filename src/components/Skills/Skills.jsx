      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10 py-4">
          ...
          {SkillsInfo.map((category) => (
            <div key={category.title} className="bg-gray-900 backdrop-blur-md px-6 sm:px-10 py-8 rounded-2xl border border-white shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] flex flex-col h-full">
              ...
              >
                <div className='grid grid-cols-2 sm:grid-cols-3 gap-4 w-full'>
                  {category.skills.map((skill) => (
                    <div key={skill.name} className="flex flex-col xl:flex-row items-center justify-center gap-2 bg-transparent border-2 border-gray-700 rounded-xl py-3 px-2 text-center hover:border-[#8245ec] transition-colors duration-300">
