...
import profileImg from '../../assets/profile_pic/Ayush_Raj_Pic.jpeg';
    ...
    <div id='about' className='py-4 px-[5vw] md:px-[7vw] lg:px-[10vw] font-sans mt-16 md:mt-24 lg:mt-32'>
      ...
      <div className='w-full max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10 lg:gap-16'>
        ...
        <div className='md:w-1/2 text-center md:text-left mt-8 md:mt-0 flex flex-col items-center md:items-start'>
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1ArxUrKZAlYHew59Scrt23HG52kbdRV1n/view?usp=sharing"
            target='_blank'
            rel='noopener noreferrer'
            className="inline-block text-white py-3 px-8 rounded-full mt-2 text-lg font-bold transition-all duration-300 transform hover:scale-105 bg-gradient-to-r from-[#5b21b6] to-[#7c3aed] shadow-[0_0_15px_rgba(130,69,236,0.5)] hover:shadow-[0_0_25px_rgba(130,69,236,0.7)]"
          >
            Download CV
          </a>
        </div>
        ...
        <div className='md:w-1/2 flex justify-center md:justify-end'>
          <Tilt className="w-56 h-56 sm:w-72 sm:h-72 md:w-[28rem] md:h-[28rem] lg:w-[32rem] lg:h-[32rem] border-4 border-purple-700 rounded-full flex-shrink-0"
            tiltMaxAngleX={5}
            tiltMaxAngleY={5}
            perspective={1000}
            scale={1.05}
